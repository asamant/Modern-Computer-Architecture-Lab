...
% in the abstract
\begin{abstract}
Embedded systems that operate in the low-power domain need to be as efficient as possible in terms of their components' power consumption, including the onboard processor(s). Caches in processors, more specifically instruction caches, are known to be power-hungry since instructions are fetched frequently for the processor's operations. This paper reviews and compares some caching techniques for the instruction cache in order to reduce the power consumed by the cache thereby reducing the overall power consumption of the embedded processor.
\end{abstract}
...
\item Briefly describe the to be detailed in the report Research Question solutions.
\item State the main conclusions of your investigation.
\item Present the report organisation (one paragraph).
\end{itemize} 
...
Describe the main idea of the solution in~\cite{paper2} and the way it works. Use your own words and in case really needed you can include figures from the original paper while giving proper reference. The text has to be self contained as the reader should be able to understand the essence of the proposed approach without reading the original paper.

\subsection{Solution 3}

Describe the main idea of the solution in~\cite{paper3} and the way it works. Use your own words and in case really needed you can include figures from the original paper while giving proper reference. The text has to be self contained as the reader should be able to understand the essence of the proposed approach without reading the original paper.

\subsection{Solution 4}

Describe the main idea of the solution in~\cite{paper4} and the way it works. Use your own words and in case really needed you can include figures from the original paper while giving proper reference. The text has to be self contained as the reader should be able to understand the essence of the proposed approach without reading the original paper.
 
\subsection{Solution 5}

Describe the main idea of the solution in~\cite{paper5} and the way it works. Use your own words and in case really needed you can include figures from the original paper while giving proper reference. The text has to be self contained as the reader should be able to understand the essence of the proposed approach without reading the original paper.

\section{Comparison}

Discuss in a critical way the analysed solutions. For each of them highlight pros and cons. Provide a qualitative (and in case possible also a quantitative) comparison of the discussed approaches.
...
\bibitem{paper1}
Author1 and Author2, \emph{Paper 1 title}, Full reference paper 1. 
\bibitem{paper2}
